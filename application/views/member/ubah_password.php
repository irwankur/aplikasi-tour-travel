      ...
      <form action="<?php echo base_url('auth/ubah_password'); ?>" method="post">
        <div class="form-group">
          <div class="form-label-group">
            <input type="password" id="inputPassword" name="password_lama" class="form-control" placeholder="Password" required="required">
            <label for="inputPassword">Password Lama</label>
          </div>
          <small class="form_error"><?php echo form_error('password_lama') ?></small>
        </div>
        <div class="form-group">
          <div class="form-label-group">
