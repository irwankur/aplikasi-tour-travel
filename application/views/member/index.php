      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between align-items-center mt-2 sticky-bottom">
            <div class="btn-group">
              <a href="<?php echo base_url('member/info/'.$row->id_perjalanan); ?>" class="btn btn-sm btn-primary tombol">Lihat</a>
            </div>
            <?php if($row->harga_diskon > 0){ ?>
  ...
  <div class="row">
    ...
    <div class="col-md-12 text-center">
      <div class="lihat_semua mb-4 mt-4">
        <a href="<?php echo base_url('member/semua_perjalanan') ?>" class="btn btn-primary btn-sm tombol">Lihat Semua</a>
      </div>
    </div>
  </div>  
</div>
