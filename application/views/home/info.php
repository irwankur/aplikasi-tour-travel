					...
					<div class="row justify-content-center">
						...
						<div class=" col-md-2">
							<div class="text-center border list_tanggal">
								...
								<a href="<?php echo base_url('auth/login_member'); ?>" class="btn btn-sm btn-warning btn-block mt-4" role="button" >PESAN</a>
							</div>
						</div>
						<?php } else {   
						...
						<div class=" col-md-2">
							<div class="list_tanggal border text-center">
								...
								<a href="<?php echo base_url('auth/login_member'); ?>" class="btn btn-sm btn-warning btn-block mt-3" role="button" >PESAN</a>
							</div>
						</div>
						<?php } }?>
					</div>
